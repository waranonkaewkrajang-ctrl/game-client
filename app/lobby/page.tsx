...
<div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none", zIndex: 0 }}>
  {Array.from({ length: 20 }).map((_, i) => (
    <div key={`dice-${i}`} style={{
      ...
      <div style={{ maxWidth: "100%", width: "100%", margin: "0", padding: "16px 12px" }}>
       ...
       {/* Tab Menu */}
          ...
          {[
            ...
            <button key={tab.id} onClick={() => { setActiveTab(tab.id); if (tab.href) router.push(tab.href); }} style={{
             ...
             display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", whiteSpace: "nowrap",
              fontSize: "0.88rem", fontWeight: 900, letterSpacing: "0.5px",
              transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
              /* ✨ ดีไซน์ใหม่: ปุ่ม 3D นูนหนาสีม่วงพรีเมียม + ตัวอักษรเด่น */
              ...
              backdropFilter: "blur(12px)",
              WebkitBackdropFilter: "blur(12px)",
              color: activeTab === tab.id ? "#ffffff" : "#d8b4fe",
              ...
              transform: activeTab === tab.id ? "translateY(-3px) scale(1.02)" : "translateY(0)",
            }}>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "flex-start" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {(isRoomMode || selectedCategory === "") && activeTab !== "recent" ? (
              <>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <span style={{
                      ...
                      boxShadow: "0 1px 3px rgba(34,197,94,0.5), inset 0 1px 0 rgba(255,255,255,0.3)",
                      letterSpacing: "0.3px",
                      whiteSpace: "nowrap",
                    }}>
                      ● ออนไลน์
