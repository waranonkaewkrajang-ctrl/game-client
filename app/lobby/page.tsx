...
export default function LobbyPage() {
  ...
  return (
  <div style={{ minHeight: "100vh", background: "linear-gradient(180deg, #1c1c2d 0%, #2a2a4a 50%, #0a0a14 100%)", paddingBottom: "0px", position: "relative", overflow: "hidden" }}>
      {/* Dice Background */}
  ...
  <div className="rank-scroll-container">
    {products.slice(0, 10).map((p, i) => {
      ...
      return (
        ...
        <div style={{ display: "flex", alignItems: "center", height: "34px", borderRadius: "6px", overflow: "hidden", marginBottom: "10px", border: "1px solid #242424", background: "transparent" }}>
