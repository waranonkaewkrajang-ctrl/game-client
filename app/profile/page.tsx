        ...
        <div onClick={() => setShowBankModal(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", backdropFilter: "blur(4px)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
          <div onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: "400px", background: "linear-gradient(180deg, rgba(88, 28, 135, 0.95) 0%, rgba(157, 23, 77, 0.97) 100%)", backdropFilter: "blur(16px)", borderRadius: "24px", padding: "28px 24px", border: "1px solid rgba(236, 72, 153, 0.4)", boxShadow: "0 20px 50px rgba(0,0,0,0.7), inset 0 2px 3px rgba(255,255,255,0.12)", fontFamily: "'Kanit', sans-serif" }}>
            ...
            <div style={{ position: "relative", marginBottom: "16px" }}>
              <div onClick={() => setBankDropdownOpen(!bankDropdownOpen)} style={{ width: "100%", boxSizing: "border-box", padding: "12px", borderRadius: "12px", background: "rgba(0,0,0,0.35)", color: "#fff", border: "1px solid rgba(255,255,255,0.2)", fontSize: "14px", cursor: "pointer", display: "flex", alignItems: "center", gap: "10px" }}>
                <img src={`/logos/${bankForm.new_bank_code}.webp`} alt="" style={{ width: "24px", height: "24px", borderRadius: "5px", objectFit: "contain", background: "#fff", padding: "2px" }} onError={(e) => e.currentTarget.style.display = 'none'} />
                <span style={{ flex: 1 }}>{bankList.find((b) => b.code === bankForm.new_bank_code)?.name || "เลือกธนาคาร"}</span>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button onClick={() => setShowBankModal(false)} style={{ flex: 1, padding: "14px", borderRadius: "14px", border: "1px solid #f87171", background: "linear-gradient(180deg, #f87171, #dc2626, #b91c1c)", color: "#fff", fontSize: "14px", fontWeight: 800, cursor: "pointer", fontFamily: "'Kanit', sans-serif", boxShadow: "0 6px 12px rgba(220,38,38,0.4), inset 0 2px 3px rgba(255,255,255,0.4), inset 0 -3px 4px rgba(127,29,29,0.6)", textShadow: "0 1px 2px rgba(0,0,0,0.3)" }}>ยกเลิก</button>
